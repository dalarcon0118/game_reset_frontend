    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <Flex vertical flex={1}>
        ...
        <Flex align="center" gap={spacing.md} padding={spacing.lg} style={styles.header}>
          ...
          <Label type="title" value="Reportar Incidencia" />
        </Flex>
          ...
          <Card style={styles.formCard}>
            <Flex vertical gap={spacing.lg}>
              <Flex vertical gap={spacing.xs}>
                <Label type="detail" value="Listero" style={styles.inputLabel} />
                <Select
              ...
              <Flex vertical gap={spacing.xs}>
                <Label type="detail" value="Sorteo" style={styles.inputLabel} />
                <Select
              ...
              <View style={styles.disclaimerContainer}>
                <Flex align="start" gap={spacing.sm}>
                  ...
                  <Label
                    type="detail"
                    value="Este reporte será visible para los administradores y quedará asociado a tu cuenta de colector."
