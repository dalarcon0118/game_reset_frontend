...
export const BET_VALUES = {
  /** @deprecated No longer consumed by betRepository. Flow controls its own timeout via ONLINE_FETCH_TIMEOUT_* */
  GET_BETS_TIMEOUT_MS: 8000,
  FINANCIAL_SUMMARY_TIMEOUT_MS: 8000,
  ONLINE_FETCH_TIMEOUT_MS: 3000,
  ONLINE_FETCH_TIMEOUT_CELLULAR_MS: 5000,
  ONLINE_FETCH_TIMEOUT_OFFLINE_MS: 1000,
  RECENT_MAX_AGE_MS: 60 * 60 * 1000,
