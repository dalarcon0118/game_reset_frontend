...
// Type for positional params
type ElmStorePositional<TModel, TMsg> = (
...
// Type for config params
type ElmStoreConfigFn<TModel, TMsg> = (
 ...
 */
export const createElmStore: ElmStorePositional<any, any> & ElmStoreConfigFn<any, any> =
    function <TModel, TMsg>(
        firstArg:
            | TModel
        ...
        if (isConfigMode) {
            ...
            const [initial, update, effectHandlers, subscriptions, middlewares] = rest;
            config = {
        ...
        return store;
    } as ElmStorePositional<any, any> & ElmStoreConfigFn<any, any>;
